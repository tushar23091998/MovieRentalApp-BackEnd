...
//                };
//            }
//            if (columnValue.FindElements(By.TagName("button")).Count > 0)
//            {
//                columnSpecialValue = new ColumnSpecialValue
//                {
//                    ElementCollection = columnValue.FindElements(By.TagName("button")),
//                    ControlType = "button"
//                };
//            }
...
//    {
//        public ICollection<IWebElement> ElementCollection { get; set; }
